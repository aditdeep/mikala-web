  ...
  return (
    <>
      <nav style={{ position:'sticky', top:0, zIndex:100, background:'rgba(255,255,255,0.95)', backdropFilter:'blur(20px)', borderBottom:'1px solid rgba(45,122,94,0.1)', boxShadow:'0 2px 20px rgba(0,0,0,0.06)' }}>
        ...
        {/* Mobile menu */}
        {open && (
          <div style={{ background:'white', borderTop:'1px solid rgba(45,122,94,0.1)', padding:'16px 20px', display:'flex', flexDirection:'column', gap:'4px' }} className="mgm-mobile-nav">
            {NAV_LINKS.map(n => (

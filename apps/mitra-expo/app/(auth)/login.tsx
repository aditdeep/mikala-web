        ...
        <ScrollView contentContainerStyle={s.container} keyboardShouldPersistTaps="handled">
          ...
          <View style={s.card}>
            ...
            <View style={s.inputWrap}>
              ...
              <TextInput value={email} onChangeText={setEmail} placeholder="nama@email.com"
                placeholderTextColor="rgba(255,255,255,0.3)" keyboardType="email-address"
            ...
            <View style={s.inputWrap}>
              ...
              <TextInput value={password} onChangeText={setPassword} placeholder="••••••••"
                placeholderTextColor="rgba(255,255,255,0.3)" secureTextEntry={!showPass}
            ...
            <TouchableOpacity onPress={()=>router.push('/(auth)/forgot-password')} style={{alignSelf:'flex-end',marginTop:6,marginBottom:16}}>
              <Text style={{color:'rgba(167,139,250,0.6)',fontSize:12}}>Lupa password?</Text>
            </TouchableOpacity>

            <TouchableOpacity onPress={handleLogin} disabled={loading} activeOpacity={0.8}>
              <LinearGradient colors={['#7c3aed','#4f46e5']} style={s.btn}>
                {loading ? <ActivityIndicator color="white" size="small"/> : <Text style={s.btnText}>Masuk</Text>}
              </LinearGradient>
            </TouchableOpacity>

            <View style={s.divider}><View style={s.line}/><Text style={s.dividerTxt}>atau</Text><View style={s.line}/></View>

            <TouchableOpacity onPress={()=>router.push('/(auth)/register')} style={s.regBtn}>
              <Text style={s.regBtnTxt}>🚀 Daftar sebagai Mitra</Text>
            </TouchableOpacity>
          </View>
...
const s = StyleSheet.create({
  ...
  errBox:{backgroundColor:'rgba(239,68,68,0.1)',borderRadius:10,padding:12,marginBottom:14},
  ...
  regBtn:{backgroundColor:'rgba(124,58,237,0.12)',borderWidth:2,borderColor:'rgba(124,58,237,0.4)',borderRadius:14,padding:14,alignItems:'center'},
  regBtnTxt:{color:'#a78bfa',fontSize:14,fontWeight:'700'},

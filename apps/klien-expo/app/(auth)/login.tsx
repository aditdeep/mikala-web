        ...
        <ScrollView contentContainerStyle={s.container} keyboardShouldPersistTaps="handled">
          ...
          <View style={s.card}>
            ...
            <View style={s.inputWrap}>
              <Ionicons name="mail-outline" size={17} color="rgba(16,185,129,0.6)" style={s.icon}/>
            ...
            <View style={s.inputWrap}>
              <Ionicons name="lock-closed-outline" size={17} color="rgba(16,185,129,0.6)" style={s.icon}/>
              ...
              <TouchableOpacity onPress={()=>setShowPass(!showPass)} style={s.eye}>
                <Ionicons name={showPass?'eye-off-outline':'eye-outline'} size={17} color="rgba(16,185,129,0.6)"/>
              </TouchableOpacity>
            </View>

            <TouchableOpacity onPress={()=>router.push('/(auth)/forgot-password')}
              style={{alignSelf:'flex-end',marginTop:6,marginBottom:16}}>
              <Text style={{color:'rgba(16,185,129,0.6)',fontSize:12}}>Lupa password?</Text>
            </TouchableOpacity>

            <TouchableOpacity onPress={handleLogin} disabled={loading} activeOpacity={0.8}>
              <LinearGradient colors={loading?['rgba(16,185,129,0.5)','rgba(5,150,105,0.5)']:['#10b981','#059669']}
                style={s.btn}>
...
const s = StyleSheet.create({
  ...
  logoBox:    { width:72, height:72, borderRadius:22, backgroundColor:'#10b981', alignItems:'center', justifyContent:'center', marginBottom:16, elevation:12 },
  logoText:   { color:'white', fontSize:28, fontWeight:'800' },
  title:      { color:'white', fontSize:26, fontWeight:'800' },
  subtitle:   { color:'rgba(16,185,129,0.8)', fontSize:14, marginTop:6, marginBottom:28 },
  ...
  label:      { color:'rgba(16,185,129,0.8)', fontSize:13, fontWeight:'500', marginBottom:8 },
  ...
  regBtn:     { flexDirection:'row', alignItems:'center', justifyContent:'center', gap:8, backgroundColor:'rgba(16,185,129,0.1)', borderWidth:1, borderColor:'rgba(16,185,129,0.3)', borderRadius:14, padding:13 },
  regTxt:     { color:'#10b981', fontSize:14, fontWeight:'600' },
